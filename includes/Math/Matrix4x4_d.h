...
namespace ZH{
    namespace Math{
        ...
        // ==
        ZH_DLL bool operator == ( const double* const, const matrix4x4_d& );
        ZH_DLL bool operator == ( double, const matrix4x4_d& );
        // !=
        ZH_DLL bool operator != ( const double* const, const matrix4x4_d& );
        ZH_DLL bool operator != ( double, const matrix4x4_d& );
 
        // matrix4x4_d * double4
        ZH_DLL double4 operator * (const matrix4x4_d&, const double4&);
    }
} // namespace ZH
