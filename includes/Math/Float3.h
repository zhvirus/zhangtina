...
namespace ZH{
    namespace Math{
        ...
        // ==
        ZH_DLL bool operator == ( const float* const, const float3& );
        // !=
        ZH_DLL bool operator != ( const float* const, const float3& );
        // +
        ZH_DLL float3 operator + ( const float* const, const float3& );
        ZH_DLL float3 operator + ( const float&, const float3& );
        // -
        ZH_DLL float3 operator - ( const float* const, const float3& );
        ZH_DLL float3 operator - ( const float&, const float3& );
        // *
        ...
        ZH_DLL float3 operator / ( const float&, const float3& );
        // +=
        ZH_DLL void operator += ( float* const, const float3& );
        // -=
        ZH_DLL void operator -= ( float* const, const float3& );
        // *=
        ZH_DLL void operator *= ( float* const, const float3& );
