...
namespace ZH{
    namespace Math{
        ...
        // ==
        ZH_DLL bool operator == ( const int* const, const int3& );
        // !=
        ZH_DLL bool operator != ( const int* const, const int3& );
        // +
        ZH_DLL int3 operator + ( const int* const, const int3& );
        ZH_DLL int3 operator + ( const int&, const int3& );
        // -
        ZH_DLL int3 operator - ( const int* const, const int3& );
        ZH_DLL int3 operator - ( const int&, const int3& );
        // *
        ...
        ZH_DLL int3 operator / ( const int&, const int3& );
        // +=
        ZH_DLL void operator += ( int* const, const int3& );
        // -=
        ZH_DLL void operator -= ( int* const, const int3& );
        // *=
        ZH_DLL void operator *= ( int* const, const int3& );
