...
#pragma warning( pop ) 
        ...
        // ==
        ZH_MATH_DLL bool operator == ( const int* const, const int4& );

        // !=
        ZH_MATH_DLL bool operator != ( const int* const, const int4& );

        // +
        ZH_MATH_DLL int4 operator + ( const int* const, const int4& );

        ZH_MATH_DLL int4 operator + ( const int&, const int4& );
        ...
        // +=
        ZH_MATH_DLL void operator += ( int* const, const int4& );
