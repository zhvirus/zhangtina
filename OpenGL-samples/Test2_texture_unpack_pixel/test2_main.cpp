...
#include "stdafx.h"
#include "..\TestCommonLib\gl_common.h"
#include <string.h>
#include <stdlib.h>
#include <stdio.h>
#include <iostream>
...
void initialize()
{
    ...
    TEST_COM::image::instance().read_image(L"C:\\Users\\Public\\Pictures\\Sample Pictures\\Tulips.jpg",
        pData, w, h, s);
    ...
    DEBUG_GL_ERRORS;
    //glTexStorage2D(GL_TEXTURE_2D, 10, , w, h);
