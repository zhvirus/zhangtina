...
int COutputWnd::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	bNameValid = strTabName.LoadString(IDS_OUTPUT_DEBUG_TAB);
	ASSERT(bNameValid);
...
{
	m_wndOutput.AddString(_T("Build output is being displayed here."));

}

void COutputWnd::FillOutputDebugWindow()
{
