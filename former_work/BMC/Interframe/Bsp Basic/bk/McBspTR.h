...
///////////////////////////////////////////////////////////////////////////////
//		CMcBspTR
// The Moton Carlo ray tracing class using Photon Map technique
///////////////////////////////////////////////////////////////////////////////
class CMcBspTR :
	public CBspTR
{
...
protected:
	...
	float      m_fLocalRadius;          // Radius of the esitmation circle
	int        m_nLocalPhoton;          // The maximun number of photon in the esitmation circle
	...
	CVec3      m_vLeftBottom;           // The left botton position of the sampling plane
...
protected:
	...
	// Initial the light patches for the creation of globel photon map and ray tracing.
	...
	virtual void _Create_global_photonmap (void);
	...
	void  _Create_photon_maps(void);
	// Bounce the global photon in the scene by the Russan-Roulette determination and the reflectivity of the surfaces.
	BOOL  _Trace_global_photon (TBspRay ray, CCol4 cPow, int nPID, int &nStored);
	// Bounce the caustic photon by the specualr surface and store it on the first-hit diffuse surface.
	...
	CCol4 _MC_radiance_along_the_ray (TBspRay &ray, int nDepth, CCol4 &cDiffIrra);
	// Estimate the radiance at the given direction using photon map
	CCol4 _PM_radiance_along_the_ray (TBspRay &ray, int nPID, BOOL &bHitLight);
	// Estimate the radiance of a pixel along the given direction using Mento Carlo integration and photon map.
	CCol4 _Pixel_radiance_PM (CVec3 &vPPos, CCol4 &cDiffIrra);
...
public:
	void  Set_photon_number (const int &nPhotonNum);
