...
public:
	...
	void  InitCamera (float fViewAngle,
					CVec3 vEye, CVec3 vCent, CVec3 vUpright,
					float fNear, float fFar,
					int nWidth, int nHeight)
	{
		if (m_nImageWidth != 0)	delete [] m_pResultImage;
	...
	int   Film_width()   {return m_nImageWidth; }
	int   Film_height()  {return m_nImageHeight;}
	CCol4 *ResultImagePtr() {return m_pResultImage;}
	...
	virtual ~CCamera()
	{
		if (m_nImageWidth) delete [] m_pResultImage;
	}
};
