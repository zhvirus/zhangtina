========================================================================
    STATIC LIBRARY : Bsp Basic Project Overview
========================================================================

AppWizard has created this Bsp Basic library project for you. 
This file contains a summary of what you will find in each of the files that
make up your Bsp Basic application.
...
StdAfx.h, StdAfx.cpp
    ...
    named Bsp Basic.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "Bsp Basic.rc" and a "Bsp Basic.h" that 
