========================================================================
    STATIC LIBRARY : PhotonMap Project Overview
========================================================================

AppWizard has created this PhotonMap library project for you. 
This file contains a summary of what you will find in each of the files that
make up your PhotonMap application.
...
StdAfx.h, StdAfx.cpp
    ...
    named PhotonMap.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "PhotonMap.rc" and a "PhotonMap.h" that 
