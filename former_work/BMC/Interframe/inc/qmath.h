...
static char quickmath_id[] = "$Id: qmath.h, build#002 2002/08/27 <G>SZ Exp $";
...
// Yanyun added 2005.12.15
__inline long int qmath_ftoi (float flt)
{
	int      i;
	static const float round_const = -0.5f;
	__asm
	{
		mov  eax, flt;
		and  eax, 80000000h;
