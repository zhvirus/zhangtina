    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            return Vector3( 
                static_cast<Real>(( x + vec.x ) * 0.5), 
                static_cast<Real>(( y + vec.y ) * 0.5), 
                static_cast<Real>(( z + vec.z ) * 0.5 ));
        }
...
//            return q * (*this);
//        }
//#ifndef DALAB_FORCE_ANGLE_TYPES
//        inline Vector3 randomDeviant(
//            Real angle,
//            const Vector3& up = Vector3::ZERO ) const
//        {
