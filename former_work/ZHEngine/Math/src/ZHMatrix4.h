...
namespace ZH
{
    /** Class encapsulating a standard 4x4 homogenous matrix.
        @remarks
            ZH uses column vectors when applying matrix multiplications,
        ...
        @par
            ZH deals with the differences between D3D and OpenGL etc.
            internally when operating through different render systems. ZH
            users only need to conform to standard maths conventions, i.e.
            right-to-left matrix multiplication, (ZH transposes matrices it
    ...
    */
    ...
    /* Removed from Vector4 and made a non-member here because otherwise
       ZHMatrix4.h and ZHVector4.h have to try to include and inline each 
