...
namespace ZH
{
    ...
    const Real Matrix3::ms_fSvdEpsilon = static_cast<Real>(1e-04);
    ...
    bool Matrix3::Inverse (Matrix3& rkInverse, Real fTolerance) const
    {
        ...
        Real fInvDet = static_cast<Real>(1.0/fDet);
        for (size_t iRow = 0; iRow < 3; iRow++)
        {
            for (size_t iCol = 0; iCol < 3; iCol++)
        ...
        Matrix3& kR)
    {
        ...
        if ( fLength > 0.0 )
        {
            fSign = static_cast<Real>((kA[0][0] > 0.0 ? 1.0 : -1.0));
            fT1 = kA[0][0] + fSign*fLength;
            fInvT1 = static_cast<Real>(1.0/fT1);
            afV[1] = kA[1][0]*fInvT1;
            afV[2] = kA[2][0]*fInvT1;

            fT2 = static_cast<Real>(-2.0/(1.0+afV[1]*afV[1]+afV[2]*afV[2]));
            ...
            kL[0][0] = static_cast<Real>(1.0+fT2);
            kL[0][1] = kL[1][0] = fT2*afV[1];
            kL[0][2] = kL[2][0] = fT2*afV[2];
            kL[1][1] = static_cast<Real>(1.0+fT2*afV[1]*afV[1]);
            kL[1][2] = kL[2][1] = fT2*afV[1]*afV[2];
            kL[2][2] = static_cast<Real>(1.0+fT2*afV[2]*afV[2]);
            bIdentity = false;
        }
        else
        {
        ...
        if ( fLength > 0.0 )
        {
            fSign =static_cast<Real>( (kA[0][1] > 0.0 ? 1.0 : -1.0));
            fT1 = kA[0][1] + fSign*fLength;
            afV[2] = kA[0][2]/fT1;

            fT2 = static_cast<Real>(-2.0/(1.0+afV[2]*afV[2]));
            ...
            kR[0][1] = kR[1][0] = 0.0;
            kR[0][2] = kR[2][0] = 0.0;
            kR[1][1] = static_cast<Real>(1.0+fT2);
            kR[1][2] = kR[2][1] = fT2*afV[2];
            kR[2][2] = static_cast<Real>(1.0+fT2*afV[2]*afV[2]);
        }
        else
        {
            kR = Matrix3::IDENTITY;
        ...
        if ( fLength > 0.0 )
        {
            fSign = static_cast<Real>((kA[1][1] > 0.0 ? 1.0 : -1.0));
            ...
            Real fA = static_cast<Real>(1.0+fT2);
            Real fB = fT2*afV[2];
            Real fC = static_cast<Real>(1.0+fB*afV[2]);
        ...
        Matrix3& kR)
    {
        ...
        Real fDiscr = static_cast<Real>(Math::Sqrt(fDiff*fDiff+4.0f*fT12*fT12));
        Real fRoot1 = static_cast<Real>(0.5*(fTrace+fDiscr));
        Real fRoot2 = static_cast<Real>(0.5*(fTrace-fDiscr));
        ...
        for (unsigned int i = 0; i < ms_iSvdMaxIterations; i++)
        {
            ...
            if ( bTest1 )
            {
                ...
                else
                {
                    ...
                    fTan0 = static_cast<Real>(0.5*(fTmp+Math::Sqrt(fTmp*fTmp + 4.0f)));
                    fCos0 = static_cast<Real>(Math::InvSqrt(1.0f+fTan0*fTan0));
                    fSin0 = fTan0*fCos0;
                    ...
                    fCos1 = static_cast<Real>(Math::InvSqrt(1.0f+fTan1*fTan1));
                    fSin1 = -fTan1*fCos1;
        ...
        Vector3& kD, Vector3& kU) const
    {
        ...
        // the shear component
        Real fInvD0 = static_cast<Real>(1.0f/kD[0]);
        kU[0] = kR[0][1]*fInvD0;
        kU[1] = kR[0][2]*fInvD0;
        kU[2] = kR[1][2]/kD[1];
    }
    ...
    Real Matrix3::MaxCubicRoot (Real afCoeff[3])
    {
        ...
        const Real fEpsilon = static_cast<Real>(1e-06);
