    ...
    public:
        ...
        */
        ...
        inline Vector2 operator / ( Real fScalar ) const
        {
            ...
            Real fInv = static_cast<float>(1.0 / fScalar);
            kDiv.x = x * fInv;
            kDiv.y = y * fInv;
        ...
        */
        inline Real normalise()
        {
            ...
            if ( fLength > 1e-08 )
            {
                Real fInvLength = static_cast<float>(1.0 / fLength);
                x *= fInvLength;
                y *= fInvLength;
            }
        ...
        */
        ...
        {
            return Vector2( 
                static_cast<float>(( x + vec.x ) * 0.5), 
                static_cast<float>(( y + vec.y ) * 0.5 ));
        }
