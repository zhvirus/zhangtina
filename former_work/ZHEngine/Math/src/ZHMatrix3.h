    ...
    */
    ...
    public:
	   ...
	   inline Matrix3 () {};
        ...
        ZH_MATH_DLL friend Vector3 operator* (const Vector3& rkVector,
        ...
        // scalar * matrix
        ZH_MATH_DLL friend Matrix3 operator* (Real fScalar, const Matrix3& rkMatrix);
